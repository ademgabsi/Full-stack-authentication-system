...
describe('UsersController', () => {
  ...
  describe('uploadImage', () => {
    ...
    it('should accept valid PNG file (magic bytes match)', async () => {
      ...
      mockUsersService.uploadImage.mockResolvedValue({
        image: 'https://img.jpg',
      });
  ...
  describe('confirmDeletion', () => {
    it('should confirm account deletion', async () => {
      mockUsersService.confirmDeletion.mockResolvedValue({
  ...
  describe('cancelDeletion', () => {
    it('should cancel account deletion', async () => {
      mockUsersService.cancelDeletion.mockResolvedValue({
        message: 'cancelled',
      });
      const result = await controller.cancelDeletion(
        'user-1',
        { code: '123456' },
        mockReq,
      );
