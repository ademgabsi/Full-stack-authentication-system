...
const StepUpVerifyPage = lazy(() => import('@/pages/auth/StepUpVerifyPage'));
...
export const router = createBrowserRouter([
...

  {
    ...
    children: [
      ...
      { path: 'step-up/verify', element: <LazyPage Component={StepUpVerifyPage} /> },
    ],
  },

  {
    element: <AuthLayout />,
    children: [
      { path: 'auth/google/callback', element: <LazyPage Component={GoogleCallbackPage} /> },
    ],
  },
